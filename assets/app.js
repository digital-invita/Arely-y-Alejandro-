    ...
    const INVITATION_CONFIG =
{
  ...
  "sectionColors": {
    ...
    function addToCalendar(event) {
      ...
      if (isIOS) {
        // Safari en iOS no soporta de forma confiable la descarga de un
        // Blob mediante el atributo "download" (a veces no hace nada, o
        // solo abre el archivo en una pestaña en vez de ofrecer guardarlo).
        // La forma estándar y confiable de abrir el diálogo nativo
        // "Agregar evento" es navegar directamente a una URL de datos con
