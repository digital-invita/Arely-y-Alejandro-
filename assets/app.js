    ...
    const INVITATION_CONFIG =
{
  ...
  "sectionColors": {
    ...
    function escapeICSValue(value) {
      return String(value || "")
        // Elimina caracteres de control y marcas invisibles (p. ej. marcas
        // de dirección de texto que a veces se arrastran al copiar desde
        // Word/WhatsApp) que pueden corromper el archivo .ics generado.
        .replace(/[\u0000-\u0008\u000B\u000C\u000E-\u001F\u007F\u200B-\u200F\u202A-\u202E\u2060-\u2064\uFEFF]/g, "")
        .replace(/\\/g, "\\\\")
        .replace(/\r?\n/g, "\\n")
        .replace(/,/g, "\\,")
